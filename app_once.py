# Blue represents a hexagon ( 1-exist 0-empty 2-watered )
# Red represents the points around the hexagon
# Define blue_array even rows biased to the left and odd rows biased to the right

# step1 : Create random blue_array
# step2 : Simulated water flows in from all around
# step3 : Statistical simulation results

# Abstract
print("shit on your face")
...
# Test find_zeros_on_boundary
# zeros_on_boundary = find_zeros_on_boundary(random_blue_array)
# print("Coordinates of zeros on the boundary:")
...
# Test find_adjacent_coordinates
# coord = (1, 1)
# adjacent_coords = find_adjacent_coordinates(coord)

# print(f"Adjacent coordinates of {coord}:")
...
# Test modify_blue_array_watered
# print("modify_blue_array_watered 1,1")
# coordinate = (1, 1)
# modify_blue_array_watered(random_blue_array, coordinate)

# for row in random_blue_array:
#     print(row)

# coordinate_out_of_bounds = (8, 8)
# modify_blue_array_watered(random_blue_array, coordinate_out_of_bounds)
...
# twos_count = count_blue_array_watered(random_blue_array)
# print(f"Number of 2s in the array: {twos_count}")
...
# Test get_blue_array_watered_pos
# array = [
#     [1, 2, 3],
#     [2, 4, 2],
#     [5, 6, 2]
...
# result = get_blue_array_watered_pos(array)
# print(f"Coordinates of 2: {result}")
...
while True:
    ...
    print("random_blue_array temp")
    for row in random_blue_array:
        print(row)

print("random_blue_array result")
for row in random_blue_array:
    print(row)
